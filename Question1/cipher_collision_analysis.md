...
Despite this, some texts ( for example: " Ace Bag Fed Cab lazy" ) can still be encrypted and decrypted correctly for specific shift values (i.e shift1 = 1, and shift2 = 2, for this example). This occurs when all characters in the text transform uniquely do not overlap with possible mappings.
