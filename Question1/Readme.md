...
README.txt
Examples folder that includes
raw_text.txt,
encrypted_text.txt, and
decrypted_text.txt
...
raw_text.txt is the original plaintext provided in the assignment specification, while encrypted_text.txt and decrypted_text.txt are the corresponding outputs generated by the encryption and decryption functions.
